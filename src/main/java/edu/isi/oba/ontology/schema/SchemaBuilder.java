...
public class SchemaBuilder {
	 ...
	 */
	public static Schema getBaseClassBasicSchema(OWLClass baseClass, OWLOntology ontology) {
		...
		if (GlobalFlags.getFlag(ConfigPropertyNames.DEFAULT_PROPERTIES)) {
			DefaultPropertyFactory.getDefaultProperties().forEach(basicClassSchema::addProperty);
		}
