...
/**
 * The type of HTTP verb/method.
 *
 * @see <a href="https://www.iana.org/assignments/http-methods/http-methods.xhtml">Internet Assigned
 *     Numbers Authority (IANA) - Hypertext Transfer Protocol (HTTP) Method Registry</a>
 */
public enum HttpMethod {
	...
	CONNECT, // no 	no 	[RFC9110, Section 9.3.6]
	COPY, // no 	yes 	[RFC4918, Section 9.8]
	DELETE, // no 	yes 	[RFC9110, Section 9.3.5]
	GET, // yes 	yes 	[RFC9110, Section 9.3.1]
	HEAD, // yes 	yes 	[RFC9110, Section 9.3.2]
